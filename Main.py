...
def show_tweet_counts():
    height = [positive_count, negative_count, neutral_count]
    bars = ('Positive Tweets', 'Negative Tweets', 'Neutral Tweets')
...
font = ('times', 16, 'bold')
title = Label(main, text='SENTIMENT ANALYSIS OF TWITTER DATA')
title.config(bg='cyan2', fg='red')  
...
countButton = Button(main, text="Show Tweet Counts", command=show_tweet_counts)
countButton.place(x=50, y=450)
